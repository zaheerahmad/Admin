<%@ Control Language="C#" AutoEventWireup="true" Inherits="ClassGenerator" Codebehind="ClassGenerator.ascx.cs" %>
    ...
    <table cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtOut" runat="server" Width="424px" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Language</td>
            <td>
